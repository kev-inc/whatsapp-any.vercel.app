                ...
                <form className='container p-4' onSubmit={submit}>
                    ...
                    <div class="mb-6 flex justify-center">
                        <input 
                            ...
                            type="number" 
                            id="number" 
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full max-w-sm p-2.5 text-center" 
